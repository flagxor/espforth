...
// Setup timer and attach timer to a led pin
  ...
  THEN(1,ERRORR);
  HEADER_IMMEDIATE("[");
  int LBRAC=COLON_OLD(5,DOLIT,INTER,TEVAL,STORE,EXITT);
  HEADER(".OK");
  ...
  int LITER=COLON_OLD(5,DOLIT,DOLIT,COMMA,COMMA,EXITT);
  ...
  int BCOMP=COLON_OLD(3,TICK,COMMA,EXITT);
  ...
  int THENN=COLON_OLD(4,HERE,SWAP,STORE,EXITT);
  HEADER_IMMEDIATE("FOR");
  int FORR=COLON_OLD(4,COMPI,TOR,HERE,EXITT);
  HEADER_IMMEDIATE("BEGIN");
  int BEGIN=COLON_OLD(2,HERE,EXITT);
  HEADER_IMMEDIATE("NEXT");
  int NEXT=COLON_OLD(4,COMPI,DONXT,COMMA,EXITT);
  HEADER_IMMEDIATE("UNTIL");
  int UNTIL=COLON_OLD(4,COMPI,QBRAN,COMMA,EXITT);
  HEADER_IMMEDIATE("AGAIN");
  int AGAIN=COLON_OLD(4,COMPI,BRAN,COMMA,EXITT);
  HEADER_IMMEDIATE("IF");
  int IFF=COLON_OLD(7,COMPI,QBRAN,HERE,DOLIT,0,COMMA,EXITT);
  HEADER_IMMEDIATE("AHEAD");
  int AHEAD=COLON_OLD(7,COMPI,BRAN,HERE,DOLIT,0,COMMA,EXITT);
  HEADER_IMMEDIATE("REPEAT");
  int REPEA=COLON_OLD(3,AGAIN,THENN,EXITT);
  HEADER_IMMEDIATE("AFT");
  int AFT=COLON_OLD(5,DROP,AHEAD,HERE,SWAP,EXITT);
  HEADER_IMMEDIATE("ELSE");
  int ELSEE=COLON_OLD(4,AHEAD,SWAP,THENN,EXITT);
  HEADER_IMMEDIATE("WHILE");
  int WHILEE=COLON_OLD(3,IFF,SWAP,EXITT);
  HEADER_IMMEDIATE("ABORT\"");
  int ABRTQ=COLON_OLD(6,DOLIT,ABORQP,HERE,STORE,STRCQ,EXITT);
  HEADER_IMMEDIATE("$\"");
  int STRQ=COLON_OLD(6,DOLIT,STRQP,HERE,STORE,STRCQ,EXITT);
  HEADER_IMMEDIATE(".\"");
  int DOTQQ=COLON_OLD(6,DOLIT,DOTQP,HERE,STORE,STRCQ,EXITT);
  ...
  HEADER_IMMEDIATE(".(");
  int DOTPR=COLON_OLD(5,DOLIT,')',PARSE,TYPES,EXITT);
  HEADER_IMMEDIATE("\\");
  int BKSLA=COLON_OLD(5,DOLIT,'\n',WORDD,DROP,EXITT);
  HEADER_IMMEDIATE("(");
  int PAREN=COLON_OLD(5,DOLIT,')',PARSE,DDROP,EXITT);
  HEADER("COMPILE-ONLY");
  int ONLY=COLON_OLD(6,DOLIT,COMPO,LAST,AT,PSTOR,EXITT);
